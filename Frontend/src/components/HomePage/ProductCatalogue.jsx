...
const ProductsCatalogue = () => {
  ...
  const handleWheelScroll = (e) => {
    ...
    if (scrollRef.current) {
      scrollRef.current.scrollLeft += e.deltaY * 2; // Adjust speed as needed
    }
  };

  return (
    <div className="container mx-auto py-12">
      <h2 className="text-3xl font-bold text-center mb-6 text-[#00B86C]">Our Products</h2>
      ...
      >
        {items.map((product) => (
          <div key={product.id} className="w-[220px] h-[300px] flex-shrink-0">
